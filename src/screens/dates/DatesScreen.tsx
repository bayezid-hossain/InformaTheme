...
export function DatesScreen() {
  ...
  const { dates, addDate, deleteDate } = useDates();
  ...
  function handleAdd() {
    ...
    setNewLabel(''); setDateValue(new Date()); setShowAdd(false);
  }
          ...
          <View className="flex-1 justify-end">
            ...
            <View className="rounded-t-3xl border-t" style={{ backgroundColor: colors.bg1, borderTopColor: colors.border }}>
              ...
              <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ padding: 24, paddingBottom: 32 }}>
                ...
                <TouchableOpacity onPress={handleAdd} className="h-[52px] rounded-[14px] justify-center items-center" style={{ backgroundColor: colors.accent }}>
