...
const sourcePropertiesPath = path.join('C:', 'Users', 'amiba', 'Projects', 'Reverse Alarm', 'android', 'local.properties');
...
function ensurePrebuild() {
    console.log('--- InformaTheme Prebuild ---');
    ...
    // 3. Sync android-src-staging → java/com/informatheme/app/
